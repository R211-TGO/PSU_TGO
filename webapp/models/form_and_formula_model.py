...
class InputType(me.EmbeddedDocument):
    ...
    input_type = me.StringField(required=True, choices=["number", "text", "select"])  # ประเภทอินพุต เช่น "number"
...
class FormAndFormula(me.Document):
    name = me.StringField(required=True, unique=True)  # ชื่อฟอร์ม เช่น "สูตรคำนวณคาร์บอนฟุตพริ้นท์ปุ๋ย"
